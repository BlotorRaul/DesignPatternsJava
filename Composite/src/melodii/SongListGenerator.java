...
public class SongListGenerator {
    ...
    public static void main(String[] args){
        ...
        SongComponent everySong = new SongGroup("melodii.Song List", "Every melodii.Song Available");

        // Composite that holds individual groups of songs
        // This holds Songs plus a melodii.SongGroup with Songs
        ...
        // This is a melodii.SongGroup that just holds Songs
