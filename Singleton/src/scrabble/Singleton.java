...
public class Singleton {
    ...
    //convertesc literele- array  in linked list cu asList()
    ...
    public static Singleton getInstance() {
        if(firstInstance == null) {
            ...
            if(firstThread){
                ...
                firstThread = false; //il schimbam inapoi la false primul thread
            ...
            synchronized(Singleton.class){
                ...
                if(firstInstance == null) {
                    ...
                    //este o tehnică utilizată în programarea orientată pe obiect pentru a amâna crearea unei
                    //instanțe a unei clase până în momentul în care este absolut necesară. În esență, este
                    //o formă de amânare a inițializării
    ...
    /* Singleton dar fara thread(SIMPLU)
    public class Singleton{
